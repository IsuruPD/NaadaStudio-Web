        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white pt-5 mt-5" id="sidebar-wrapper">                
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-dark p-3 ac" href="profileupdate.php">Update</a>
                    <a class="list-group-item list-group-item-action list-group-item-dark p-3" href="profilereservations.php">Reservations</a>
            ...
            <div class="container-fluid content">
                <!-- Update Profile Form -->
    <section class="containerUpdateProfile" style="background-image: url('images/imgg.jpg')"> <!--style="background-image: url('images/locinst.jpg');" -->
            ...
            <div>
                <form action="#" method="post">
                    ...
                    <div class="txtInputParentUpdateProfile">
                        ...
                        <div class="txtInputUpdateProfile inlineUpdateProfile">
                            <input type="password" name="newPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
