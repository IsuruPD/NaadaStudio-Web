        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white pt-5 mt-5" id="sidebar-wrapper">                
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-dark p-3 ac" href="profiledashboard.php">Profile</a>
            ...
            <div class="container-fluid content">
                ...
                <section class="containerProfile" style="background-image: url('images/bgimg1.jpg')">
